    ...
    <div class="row">
      <div class="col-12">
        <div class="border p-1">
          ...
          <div class="player-card text-center" v-if="state.player.isShown === true">
            <div>
        ...
        <div class="border p-1">
          ...
          <!-- add code to element below -->
          <div class="player-card text-center" v-if="state.player.isShown">
            <div>
              <img :src="state.player.photo" />
            </div>
            <div>
